...
export const TRAITS = [
  { id: 'loyal', label: 'Loyal', axis: 'stability', w: 10,
    blurb: 'Values stability and the relationships already built; slow to leave a good situation.',
    affinity: ['family_oriented', 'security_seeking', 'professional'] },
  { id: 'restless', label: 'Restless', axis: 'stability', w: 7,
    blurb: 'Grows willing to move on once the situation stagnates.',
  ...
  { id: 'ego_driven', label: 'Ego-Driven', axis: 'ego', w: 8,
    blurb: 'Wants status, recognition and a starring role, and notices when none of it arrives.',
  ...
  { id: 'ambitious', label: 'Ambitious', w: 10,
    blurb: 'Driven by advancement, recognition and getting further than the current standing.',
    affinity: ['opportunity_seeking', 'market_conscious', 'restless'] },
  { id: 'professional', label: 'Professional', w: 12,
    blurb: 'Takes preparation and obligations to the organisation seriously.',
    affinity: ['lead_by_example', 'mentor', 'team_first'] },
  { id: 'independent', label: 'Independent', w: 7,
    blurb: 'Values autonomy and bristles at being over-managed.',
    affinity: ['private', 'restless'] },
  { id: 'competitive', label: 'Competitive', w: 11,
    blurb: 'Needs to be somewhere that is trying to win; losing wears fast.',
    affinity: ['legacy_minded', 'demanding', 'vocal_leader'] },
  { id: 'mentor', label: 'Mentor', w: 8, minAge: 27,
    blurb: 'Takes younger teammates under a wing and enjoys doing it.',
    affinity: ['professional', 'team_first', 'lead_by_example'] },
  { id: 'social', label: 'Social', w: 8,
    blurb: 'Locker-room relationships and culture matter a great deal.',
  ...
  { id: 'money_motivated', label: 'Money-Motivated', w: 9,
    blurb: 'Maximising the contract carries real weight in every decision.',
    affinity: ['security_seeking', 'ambitious'] },
  { id: 'legacy_minded', label: 'Legacy-Minded', w: 7,
    blurb: 'Thinks in terms of rings, awards and how the career will be remembered.',
    affinity: ['competitive', 'ambitious'] },
  { id: 'security_seeking', label: 'Security-Seeking', w: 8,
    blurb: 'Wants guaranteed money and a contract to plan a life around.',
