...
export const GROUPS = [
  ...
  },
  {
    ...
    settings: [
      ...
      { key: 'playoffSeriesLength', label: 'Series Length', type: 'choice',
        options: ['1', '3', '5', '7', '9'], def: '7', applied: true,
        help: 'Games in a playoff series. Always odd, so a series cannot be drawn. 1 makes every round a single game.' },
